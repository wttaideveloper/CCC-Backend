...
export class RoadMapsController {
    ...
    @Post()
    async createRoadMap(@Body() dto: CreateRoadMapDto): Promise<BaseResponse<RoadMapResponseDto>> {
    ...
    @Get(':id')
    async getRoadMapById(@Param('id') id: string): Promise<BaseResponse<RoadMapResponseDto>> {
    ...
    async getCommentThread(
        ...
        const thread = await this.roadMapsService.getCommentThread(roadMapId, userId);
        return {
            success: true,
